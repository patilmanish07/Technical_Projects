    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource() == SUBMIT)
        {
            ...
            else
            {
                ...
                if(attempt == 0)
                {
                    JOptionPane.showMessageDialog(this,"Number of attempts finoshed","Marvellous Packer Unpacker",JOptionPane.ERROR_MESSAGE);
                        this.dispose();
                    System.exit(0);    
                }

                JOptionPane.showMessageDialog(this, "Incprrect login or password","Error",JOptionPane.ERROR_MESSAGE);
